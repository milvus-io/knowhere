...
float CalcRecall(int64_t topk, int64_t k, int nq, knowhere::SimpleIndexFlat::idx_t* gt, knowhere::SimpleIndexFlat::idx_t* nt) {
...
int main() {
    ...
    {
        long long *I = new long long[k * nq];
    ...
    // First SQ8, then IndexRefineFlat
    {
        ...
        float *D = new float[k * nq];
        knowhere::SimpleIndexFlat* sq = new knowhere::SimpleIndexFlatScalarQuantizer(d, knowhere::QuantizerType::QT_8bit);
        knowhere::SimpleIndexFlatRefineFlat rf = knowhere::SimpleIndexFlatRefineFlat(sq);
        rf.train(nb, xb);
        rf.add(nb, xb);
        rf.k_factor = 4;
    ...
    // SQ8 alone
    {
        long *I = new long[k * nq];
        float *D = new float[k * nq];
        auto sq = new knowhere::SimpleIndexFlatScalarQuantizer(d, knowhere::QuantizerType::QT_8bit);
        sq->train(nb, xb);
        sq->add(nb, xb);
...
int main()
{
    ...
    knowhere::SimpleIndexFlat * index;
...

    {
        ...
        index = knowhere::SimpleIndexFlat_factory(d, index_key);
    ...
    //     knowhere::OneRecallAtRCriterion crit(nq, 1);
    ...
    //     knowhere::ParameterSpace params;
    ...
    { // Use the found configuration to perform a search
        ...
        // output buffers
        knowhere::SimpleIndexFlat::idx_t *I = new  knowhere::SimpleIndexFlat::idx_t[nq * k];
