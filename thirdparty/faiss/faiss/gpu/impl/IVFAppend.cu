    ...
    if (!scalarQ) {
        ...
        switch (scalarQ->qtype) {
            case QuantizerType::QT_8bit: {
                Codec<QuantizerType::QT_8bit, 1> codec(
                        scalarQ->code_size,
            ...
            case QuantizerType::QT_8bit_uniform: {
                Codec<QuantizerType::QT_8bit_uniform, 1> codec(
                        scalarQ->code_size,
                        scalarQ->trained[0],
                        scalarQ->trained[1]);
                RUN_APPEND;
            ...
            case QuantizerType::QT_fp16: {
                Codec<QuantizerType::QT_fp16, 1> codec(
                        scalarQ->code_size);
                RUN_APPEND;
            } break;
            case QuantizerType::QT_8bit_direct: {
                Codec<QuantizerType::QT_8bit_direct, 1> codec(
                        scalarQ->code_size);
                RUN_APPEND;
            } break;
            case QuantizerType::QT_4bit: {
                Codec<QuantizerType::QT_4bit, 1> codec(
                        scalarQ->code_size,
                        scalarQ->gpuTrained.data(),
                        scalarQ->gpuTrained.data() + dim);
                RUN_APPEND;
            ...
            case QuantizerType::QT_4bit_uniform: {
                Codec<QuantizerType::QT_4bit_uniform, 1> codec(
                        scalarQ->code_size,
                        scalarQ->trained[0],
                        scalarQ->trained[1]);
                RUN_APPEND;
...
#define RUN_APPEND(ENCODE_T, ENCODE_BITS, DATA)     \
    ...
    if (scalarQ->bits == 16) {
        ...
        using CodecT = Codec<QuantizerType::QT_fp16, 1>;
        ...
        switch (scalarQ->qtype) {
            case QuantizerType::QT_8bit: {
                using CodecT = Codec<QuantizerType::QT_8bit, 1>;
                CodecT codec(
                        scalarQ->code_size,
                        scalarQ->gpuTrained.data(),
                        scalarQ->gpuTrained.data() + dim);
            ...
            case QuantizerType::QT_8bit_uniform: {
                using CodecT = Codec<QuantizerType::QT_8bit_uniform, 1>;
                CodecT codec(
                        scalarQ->code_size,
                        scalarQ->trained[0],
                        scalarQ->trained[1]);
            ...
            case QuantizerType::QT_8bit_direct: {
                using CodecT = Codec<QuantizerType::QT_8bit_direct, 1>;
            ...
            case QuantizerType::QT_6bit: {
                using CodecT = Codec<QuantizerType::QT_6bit, 1>;
                CodecT codec(
                        scalarQ->code_size,
                        scalarQ->gpuTrained.data(),
                        scalarQ->gpuTrained.data() + dim);
            ...
            case QuantizerType::QT_4bit_uniform: {
                using CodecT = Codec<QuantizerType::QT_4bit_uniform, 1>;
                CodecT codec(
                        scalarQ->code_size,
                        scalarQ->trained[0],
                        scalarQ->trained[1]);
