...
struct Codec4bit_avx512 : public Codec4bit_avx {
    static __m512 decode_16_components(const uint8_t *code, int i) {
        ...
        __m128i c16 = _mm_unpacklo_epi8(
                _mm_set1_epi64x(c8ev), _mm_set1_epi64x(c8od));
...
struct QuantizerTemplate_avx512<Codec, true, 16>
    ...
    __m512 reconstruct_16_components(const uint8_t* code, int i) const {
        ...
        return _mm512_add_ps(
                _mm512_set1_ps(this->vmin),
                _mm512_mul_ps(xi, _mm512_set1_ps(this->vdiff)));
    }
};
...
struct QuantizerTemplate_avx512<Codec, false, 16>
    ...
    __m512 reconstruct_16_components(const uint8_t* code, int i) const {
        ...
        return _mm512_add_ps(
                ...
                _mm512_mul_ps(xi, _mm512_loadu_ps(this->vdiff + i)));
    }
};
...
Quantizer* select_quantizer_1_avx512(
    ...
    switch (qtype) {
        case QuantizerType::QT_8bit:
            return new QuantizerTemplate_avx512<Codec8bit_avx512, false, SIMDWIDTH>(
                    d, trained);
        case QuantizerType::QT_6bit:
            return new QuantizerTemplate_avx512<Codec6bit_avx512, false, SIMDWIDTH>(
                    d, trained);
        case QuantizerType::QT_4bit:
            return new QuantizerTemplate_avx512<Codec4bit_avx512, false, SIMDWIDTH>(
                    d, trained);
        case QuantizerType::QT_8bit_uniform:
            return new QuantizerTemplate_avx512<Codec8bit_avx512, true, SIMDWIDTH>(
                    d, trained);
        case QuantizerType::QT_4bit_uniform:
            return new QuantizerTemplate_avx512<Codec4bit_avx512, true, SIMDWIDTH>(
                    d, trained);
...
struct SimilarityL2_avx512<16> {
    ...
    void add_16_components(__m512 x) {
        ...
        accu16 = _mm512_add_ps(accu16, _mm512_mul_ps(tmp, tmp));
    }
...
struct SimilarityIP_avx512<16> {
    ...
    void add_16_components(__m512 x) {
        __m512 yiv = _mm512_loadu_ps(yi);
        yi += 16;
        accu16 = _mm512_add_ps(accu16, _mm512_mul_ps(yiv, x));
    }

    void add_16_components_2(__m512 x1, __m512 x2) {
        accu16 = _mm512_add_ps(accu16, _mm512_mul_ps(x1, x2));
    }
...
SQDistanceComputer* select_distance_computer_avx512(
    ...
    switch (qtype) {
        ...
        case QuantizerType::QT_8bit:
            return new DCTemplate_avx512<
                    QuantizerTemplate_avx512<Codec8bit_avx512, false, SIMDWIDTH>,
                    Sim,
                    SIMDWIDTH>(d, trained);

        case QuantizerType::QT_6bit:
            return new DCTemplate_avx512<
                    QuantizerTemplate_avx512<Codec6bit_avx512, false, SIMDWIDTH>,
                    Sim,
                    SIMDWIDTH>(d, trained);

        case QuantizerType::QT_4bit:
            return new DCTemplate_avx512<
                    QuantizerTemplate_avx512<Codec4bit_avx512, false, SIMDWIDTH>,
                    Sim,
                    SIMDWIDTH>(d, trained);
