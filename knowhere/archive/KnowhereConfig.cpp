...
std::string KnowhereConfig::SetSimdType(const SimdType simd_type) {
#ifdef __APPLE__
...
void KnowhereConfig::SetBlasThreshold(const int64_t use_blas_threshold) {
#ifdef __APPLE__
  // do nothing
#elif __linux__
...
void KnowhereConfig::SetEarlyStopThreshold(const double early_stop_threshold) {
#ifdef __APPLE__
  // do nothing
#elif __linux__
...
void KnowhereConfig::SetClusteringType(const ClusteringType clustering_type) {
#ifdef __APPLE__
  // do nothing
#elif __linux__
...
void KnowhereConfig::SetLogHandler() {
#ifdef __APPLE__
  // do nothing
#elif __linux__
...
#ifdef KNOWHERE_GPU_VERSION
void KnowhereConfig::InitGPUResource(const std::vector<int64_t>& gpu_ids) {
  for (auto id : gpu_ids) {
...
void KnowhereConfig::FreeGPUResource() {
