...
class SPTAGParameterMgr {
 public:
  const Config& GetKDTParameters();

  const Config& GetBKTParameters();

 public:
  static SPTAGParameterMgr& GetInstance() {
  ...
  SPTAGParameterMgr& operator=(const SPTAGParameterMgr&) = delete;
