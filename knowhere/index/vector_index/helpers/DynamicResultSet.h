...
struct DynamicResultSet {
  ...
  size_t
      count;  /// size of the result buffer's size, when reaches this size, auto start a new buffer

  void AlloctionImpl();

  void SortImpl(ResultSetPostProcessType postProcessType = ResultSetPostProcessType::SortAsc);
...
struct DynamicResultCollector {
 public:
   ...
   */
  DynamicResultSet Merge(size_t limit = 10000,
                         ResultSetPostProcessType postProcessType = ResultSetPostProcessType::None);
