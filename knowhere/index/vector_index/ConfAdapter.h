...
class ConfAdapter {
 public:
  virtual bool CheckTrain(Config& oricfg, const IndexMode mode);

  virtual bool CheckSearch(Config& oricfg, const IndexType type, const IndexMode mode);
};
using ConfAdapterPtr = std::shared_ptr<ConfAdapter>;

class IVFConfAdapter : public ConfAdapter {
 public:
  bool CheckTrain(Config& oricfg, const IndexMode mode) override;

  bool CheckSearch(Config& oricfg, const IndexType type, const IndexMode mode) override;
};
...
class IVFPQConfAdapter : public IVFConfAdapter {
 public:
  ...
  static bool CheckPQParams(int64_t dimension, int64_t m, int64_t nbits, IndexMode& mode);

  static bool CheckGPUPQParams(int64_t dimension, int64_t m, int64_t nbits);

  static bool CheckCPUPQParams(int64_t dimension, int64_t m);
};
