...
ConfAdapterPtr AdapterMgr::GetAdapter(const IndexType type) {
...
void AdapterMgr::RegisterAdapter() {
  ...
  // though init_ won't be used later, it's better to set `init_` to true after registration was
  // done.
  init_ = true;
}
