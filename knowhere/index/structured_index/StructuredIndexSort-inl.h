...
template <typename T>
const faiss::ConcurrentBitsetPtr StructuredIndexSort<T>::Range(const T value,
...
template <typename T>
const faiss::ConcurrentBitsetPtr StructuredIndexSort<T>::Range(T lower_bound_value,
                                                               bool lb_inclusive,
                                                               T upper_bound_value,
                                                               bool ub_inclusive) {
  if (!is_built_) {
