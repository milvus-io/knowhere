...
uint64_t _mm256_hsum_epi64(__m256i v) {
  return _mm256_extract_epi64(v, 0) + _mm256_extract_epi64(v, 1) + _mm256_extract_epi64(v, 2) +
...
int popcnt_AVX512VBMI_lookup(const uint8_t* data, const size_t n) {
  size_t i = 0;

  const __m512i lookup = _mm512_setr_epi64(
      0x0302020102010100llu, 0x0403030203020201llu, 0x0302020102010100llu, 0x0403030203020201llu,
      0x0302020102010100llu, 0x0403030203020201llu, 0x0302020102010100llu, 0x0403030203020201llu);
...
int xor_popcnt_AVX512VBMI_lookup(const uint8_t* data1, const uint8_t* data2, const size_t n) {
  size_t i = 0;
...
int or_popcnt_AVX512VBMI_lookup(const uint8_t* data1, const uint8_t* data2, const size_t n) {
  size_t i = 0;
...
int and_popcnt_AVX512VBMI_lookup(const uint8_t* data1, const uint8_t* data2, const size_t n) {
  size_t i = 0;
...
float jaccard_AVX512(const uint8_t* a, const uint8_t* b, size_t n) {
